...
from flaskblog1 import db, bcrypt
from flaskblog1.models import User, Post
from flaskblog1.users.forms import (RegistrationForm, LoginForm, UpdateAccountForm,
                                    RequestResetForm, ResetPasswordForm)
from flaskblog1.users.utils import save_picture, send_reset_email
...
def reset_request():
    ...
    if form.validate_on_submit():
        ...
        flash("If an account exists for this email address, a message with reset instructions will be sent at it", "info")
